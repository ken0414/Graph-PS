...
out_test = "out_test"
positive = "data/train_positive.csv"          # modify if you want to use different dataset
negative = "data/train_negative.csv"
...
def train_and_test(df):
    ...
    os.system('copy /y E:\Studies\Code\\Graph-Root\independent_testset\\test_label E:\Studies\Code\\Graph-Root\out_test')       # remember to change your path
    os.system('copy /y E:\Studies\Code\\Graph-Root\independent_testset\\test_fasta E:\Studies\Code\\Graph-Root\out_test')

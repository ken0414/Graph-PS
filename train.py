...
def train(model, epoch, model_num, dtpath):
    train_features, train_graphs, train_labels = load_data(dtpath + trainset, dtpath + trainlabel, Dataset_Path + "pssm/", Dataset_Path + "graph/")
    val_features, val_graphs, val_labels = load_data(dtpath + testset, dtpath + testlabel, Dataset_Path + "pssm/", Dataset_Path + "graph/")
